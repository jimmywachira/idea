<x-layout>
        <div class="card bg-neutral p-4 text-neutral-content max-w-4xl mx-auto mt-12 mb-24">
            ...
            <div class="col-span-full p-2">
                ...
                <textarea name="description" id="description" class="block w-full border-blue-700 p-2 border-2 rounded-md m-2" required placeholder="What's your idea?"></textarea>
